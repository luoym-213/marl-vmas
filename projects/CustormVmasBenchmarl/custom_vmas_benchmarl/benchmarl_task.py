"""BenchMARL task adapter for the custom VMAS scenario."""
...
except ImportError:  # Older TorchRL versions exposed it here.
...
class CustomVmasNavigationTask(Task):
    """Enum wrapper so BenchMARL can consume this project task."""
