"""Communication-limited wrapper around VMAS discovery."""
...
from vmas.scenarios.discovery import Scenario as VmasDiscoveryScenario
from vmas.simulator.core import Agent, World

from comm_limited_vmas.communication import CommunicationManager


class Scenario(VmasDiscoveryScenario):
    """VMAS discovery with cached peer states appended to observations."""
    ...
    def observation(self, agent: Agent) -> Tensor:
        ...
        if self.use_agent_lidar:
            observation_parts.append(agent.sensors[1].measure())
        ...
        observation_parts.extend(peer_pos)
