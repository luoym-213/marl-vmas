...
- `success_step_mean`: 66.8235
- `failure_rate`: 0.734375
- `partial_failure_rate`: 0.453125
- `visited_targets_mean`: 1.60938
- `detected_targets_mean`: 2.75
- `retired_agents_mean`: 1.60938
- `explore_actions_mean`: 9.04688
- `target_actions_mean`: 1.8125
- `goal_hits_mean`: 9.51562
- `active_step_hit_rate_mean`: 0.0428504
- `duplicate_assignment_steps_mean`: 0
- `duplicate_assignment_excess_mean`: 0
- `detected_unassigned_steps_mean`: 130.641
- `switch_away_actions_mean`: 0
- `discovery_to_assignment_delay_mean`: 29.7695
- `assignment_to_visit_delay_mean`: 18.6341
- `entropy_reduction_mean`: 16995.9
- `reason_detected_unvisited_remaining`: 47
- `reason_detected_unvisited_remaining_rate`: 0.734375
- `reason_success`: 17
- `reason_success_rate`: 0.265625
- `partial_visited_mean`: 1.7931
- `partial_detected_mean`: 3
- `partial_undiscovered_mean`: 0
- `partial_detected_unvisited_mean`: 1.2069
- `partial_retired_mean`: 1.7931
- `partial_explore_actions_mean`: 7.72414
- `partial_target_actions_mean`: 2.2069
- `partial_duplicate_assignment_excess_mean`: 0
- `partial_detected_unassigned_steps_mean`: 134.655
- `partial_switch_away_actions_mean`: 0
- `partial_discovery_to_assignment_delay_mean`: 31.0632
- `partial_assignment_to_visit_delay_mean`: 17.5345
- `partial_last_visit_step_mean`: 64.3793
