...
- `explore_actions_mean`: 6.25
- `target_actions_mean`: 2
- `goal_hits_mean`: 7.375
- `active_step_hit_rate_mean`: 0.0399404
...
- `assignment_to_visit_delay_mean`: 18.6042
- `entropy_reduction_mean`: 15318.8
...
- `partial_explore_actions_mean`: 6.71429
- `partial_target_actions_mean`: 1.85714
...
- `partial_assignment_to_visit_delay_mean`: 19.2143
- `partial_last_visit_step_mean`: 54
