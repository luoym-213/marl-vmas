...
- `explore_actions_mean`: 8.375
- `target_actions_mean`: 2.125
- `goal_hits_mean`: 8.875
- `active_step_hit_rate_mean`: 0.0392896
...
- `assignment_to_visit_delay_mean`: 13.0476
- `entropy_reduction_mean`: 17575.2
...
- `partial_explore_actions_mean`: 8.33333
- `partial_target_actions_mean`: 2.33333
- `partial_duplicate_assignment_excess_mean`: 13.5
...
- `partial_assignment_to_visit_delay_mean`: 12.8333
- `partial_last_visit_step_mean`: 66.6667
